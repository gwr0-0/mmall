...
public class ProductController {
    ...
    //categoryId为空的时候，仅使用keyword搜索
    //http://www.gaowr.com/product/keyword/洗衣机/1/10/price_asc
    ...
    //keyword为空的时候，仅使用categoryId搜索
    //http://www.gaowr.com/product/category/100001/1/10/price_asc
